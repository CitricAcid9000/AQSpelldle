...
1. make each spell an idependant dictionary with the spell name as the key and the spell information as the value
2. Make sure that the spell names are not duplicated in the same document by condesning them and combining them into a single dictionary
   - This is done by the getSpellDicts function, which takes in a spell table
'''
